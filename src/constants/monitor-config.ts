...
const MONITOR_SEEDS: Record<DiseaseSlug, Record<ControlSlug, MonitorSeed>> = {
  measles: {
    'in-house-control': {
      ...
      seedVersion: 'measles-in-house-attributed-v1',
    ...
    'positive-control': {
      ...
      seedVersion: 'measles-positive-attributed-v1',
    ...
    'negative-control': {
      ...
      seedVersion: 'measles-negative-attributed-v1',
  ...
  rubella: {
    ...
    'negative-control': {
      ...
      seedVersion: 'rubella-negative-attributed-v1',
  ...
  rotavirus: {
    ...
    'negative-control': {
      ...
      seedVersion: 'rotavirus-negative-attributed-v1',
  ...
  'japanese-encephalitis': {
    ...
    'negative-control': {
      ...
      seedVersion: 'japanese-encephalitis-negative-attributed-v1',
  ...
  dengue: {
    ...
    'negative-control': {
      ...
      seedVersion: 'dengue-negative-attributed-v1',
