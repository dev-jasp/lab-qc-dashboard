                    ...
                    <div className="relative z-10 min-h-[260px] flex flex-col">
                      ...
                      >
                        <div className="mb-5 flex items-start justify-between gap-3">
                          ...
                          <div
                            className="inline-flex items-center gap-2 rounded-full border px-3 py-1.5 text-[11px] font-bold uppercase tracking-[0.14em] whitespace-nowrap"
                            style={{
                        ...
                        <div className="mb-6">
                          <p className="text-sm max-w-xl leading-6" style={{ color: '#526377' }}>
